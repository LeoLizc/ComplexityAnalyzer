...
public class AnalyzerV0 {
//    public static void main(String[] args) {
//
//        FileReader fileReader = new FileReader("burbuja2.txt");
//        if (fileReader.open()) {
//            fileReader.readLine(); // Descard line
//            Expression exp = analise(fileReader);
//            fileReader.close();
//
...
//    }
    ...
    static Expression analise(FileReader file) {
    ...
    static Expression analiseIf(FileReader file) {
        String line;
...
//        System.out.println("Last line after If analysis: " + file.getLastLine());
    ...
    static Expression analiseFor(FileReader file, String props) {
        String line;
        Expression expression = new Expression();
...
//        System.out.println("Final Expression after For: " + finalExpression);
    ...
    static Expression applyForProps(Term term, ForProperties props) {
        Expression result;
    ...
    static Expression applyForPropsI(Term term, ForProperties props) {
...
//        Term variableTerm = new Term(1, props.variable + (exponent > 1 ? "^" + exponent : ""));
    ...
    static Expression applyPureForPropsI(int exponent, String end) {
        Expression result = new Expression();
//        int exponent = term.getVariableExponent(props.variable);
    ...
    static Expression applyForPropsC(Term term, ForProperties props) {
        Expression result = new Expression();
    ...
    static boolean isFinalExpression(String line) {
